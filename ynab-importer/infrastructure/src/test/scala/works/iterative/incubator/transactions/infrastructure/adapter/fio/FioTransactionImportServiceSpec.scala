...
object FioTransactionImportServiceSpec extends ZIOSpecDefault:
                ...
                transactionList = FioTransactionList(
                    transaction = List(
                        ...
                        FioTransaction(
                            ...
                            column7 = Some(FioTransactionValue("Company A", "Uživatelská identifikace", 7)),
                            column8 = Some(FioTransactionValue("Payment", "Typ", 8)),
                            column9 = None,
                            column10 = Some(FioTransactionValue("Invoice 001", "Zpráva pro příjemce", 10)),
                        ...
                        FioTransaction(
                            ...
                            column6 = None,
                            column7 = Some(FioTransactionValue("Company B", "Uživatelská identifikace", 7)),
                            column8 = Some(FioTransactionValue("Withdrawal", "Typ", 8)),
                            column9 = None,
                            column10 = Some(FioTransactionValue("Invoice 002", "Zpráva pro příjemce", 10)),
    ...
    def testEnv(): ZIO[Any, Nothing, (FioTransactionImportService, TransactionRepository, MockSourceAccountRepository)] = {
        for {
            ...
            importService <- ZIO.succeed(new FioTransactionImportService(fioClient, txRepo, sourceRepo))
