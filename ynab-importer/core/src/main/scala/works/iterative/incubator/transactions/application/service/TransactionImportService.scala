...
/** Service responsible for importing transactions from external sources
  *
  * This interface defines the contract for services that import transactions from
  * external sources like bank APIs.
  *
...
trait TransactionImportService:
    ...
    /** Import new transactions since a specific transaction ID
      *
      * @param lastId Optional ID of the last imported transaction
      * @return Number of transactions imported
      */
