...
/** Service interface for user management
  *
  * This service provides methods for managing users, including creation,
...
trait UserService:
    ...
    /** Deactivate a user
      *
      * @param id The user ID
      * @return True if the user was deactivated, false if not found
      */
    ...
    /** Activate a user
      *
      * @param id The user ID
      * @return True if the user was activated, false if not found
      */
