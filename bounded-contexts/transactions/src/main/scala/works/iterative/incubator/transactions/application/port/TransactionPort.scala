...
/** Transaction Port
  *
  * Port interface for the Transaction Management context to communicate with external systems. This
  * defines the boundary between the Transaction context and other contexts.
  *
...
trait TransactionPort:
    /** Submit processed transactions to external systems
      ...
      *   The IDs of the transactions to submit
      * @param sourceAccountId
      *   The ID of the source account
      * @return
      *   A map of transaction IDs to submission results
      */
