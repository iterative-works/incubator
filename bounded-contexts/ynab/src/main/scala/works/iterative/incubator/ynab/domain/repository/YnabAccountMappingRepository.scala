...
/** Repository interface for YnabAccountMapping entities
  *
  * This repository is responsible for managing the mappings between source accounts in the
  * transactions context and YNAB accounts.
  *
...
end YnabAccountMappingRepository
