 ...
 *
 * Port interface for sending transactions from the Transaction Management context to YNAB.
 * This defines the boundary between the Transaction context and the YNAB context.
 *
...
trait YnabTransactionPort:
     ...
     * @return A map of transaction IDs to their YNAB transaction IDs
     */
     ...
     *
     * @param sourceAccountId The ID of the source account
     * @param ynabAccountId The ID of the YNAB account
