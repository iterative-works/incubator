...
/** Mapping between source accounts and YNAB accounts
  *
  * This entity maintains the relationship between source accounts in the transactions context and
  * YNAB accounts, acting as an anti-corruption layer between the two bounded contexts.
  *
