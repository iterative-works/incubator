...
/** Event emitted when a new transaction is imported from a bank.
  *
  * This event is published whenever a transaction is successfully imported from a bank into the
  * system.
  *
  * @param transactionId
  *   The unique identifier of the imported transaction
  * @param sourceAccountId
  *   The source account from which the transaction was imported
  * @param date
