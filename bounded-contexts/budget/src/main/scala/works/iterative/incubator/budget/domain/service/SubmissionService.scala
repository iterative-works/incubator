...
/** Service interface for transaction submission functionality
  *
  * This service handles the workflow of submitting transactions to external
  * budget systems (currently YNAB), validating transactions before submission,
  * and emitting appropriate domain events.
  *
