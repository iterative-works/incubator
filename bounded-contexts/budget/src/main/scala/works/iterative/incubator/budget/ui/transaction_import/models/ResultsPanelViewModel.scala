...
case class ResultsPanelViewModel(
    ...
    /** Determines if the success summary should be shown.
      *
      * @return
      *   true if results exist and are successful
      */
    ...
    /** Determines if the error message should be shown.
      *
      * @return
      *   true if results exist and contain an error
      */
    ...
    /** Gets the number of transactions imported.
      *
      * @return
      *   the transaction count from results, or 0 if no results
      */
    ...
    /** Gets the error message if present.
      *
      * @return
      *   the error message from results, or None if no error
      */
    ...
    /** Gets the completion time in seconds if available.
      *
      * @return
      *   the completion time in seconds, or None if not completed
      */
