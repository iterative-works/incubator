...
/** Represents the confidence in a categorization decision
  *
  * This value object ensures that confidence scores are always within the valid range of 0.0 to
  * 1.0, where:
  *   - 0.0 represents no confidence
  *   - 1.0 represents absolute confidence
  *
  * @param value
  *   The confidence score, between 0.0 and 1.0 inclusive
  *
...
object ConfidenceScore:
    ...
    /** Create a new ConfidenceScore instance, ensuring the value is within valid bounds.
      *
      * @param value
      *   The raw score value, will be clamped to [0.0, 1.0]
      * @return
      *   A validated ConfidenceScore instance
      */
    ...
    /** Create a new ConfidenceScore from a value that might be outside the valid range.
      ...
      *   The raw score value
      * @return
      *   Either a validation error or a valid ConfidenceScore
      */
