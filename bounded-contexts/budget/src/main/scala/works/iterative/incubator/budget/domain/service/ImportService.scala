...
import works.iterative.incubator.budget.domain.event.ImportCompleted

/** Service interface for the transaction import workflow
  *
  * The ImportService handles the workflow of importing transactions from various sources, detecting
  * duplicates, creating domain entities, and publishing appropriate events.
  *
...
/** Data transfer object for raw transaction data from external sources
  *
  * This DTO contains the minimal information needed to create a Transaction entity. It represents
  * the raw data from external systems before domain validation.
  */
