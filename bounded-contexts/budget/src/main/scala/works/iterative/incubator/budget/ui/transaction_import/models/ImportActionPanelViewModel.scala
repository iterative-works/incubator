...
/**
 * View model for the import action panel component that contains import button and status indicator.
 *
 * @param isEnabled Whether the import action is enabled
 * @param status The current status of the import operation
 * @param startDate The selected start date for import
 * @param endDate The selected end date for import
 */
case class ImportActionPanelViewModel(
     ...
     *
     * @return true if the status is InProgress
     */
     ...
     *
     * @return true if the status is not NotStarted
     */
     ...
     *
     * @return A string of the form "YYYY-MM-DD to YYYY-MM-DD"
     */
     ...
     *
     * @return Status text appropriate for the current status
     */
