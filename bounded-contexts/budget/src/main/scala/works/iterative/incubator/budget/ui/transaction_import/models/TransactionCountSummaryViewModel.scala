...
/** View model for the transaction count summary component.
  ...
  * @param startDate
  *   Start of import date range
  * @param endDate
  *   End of import date range
  * @param completionTimeSeconds
  *   Time taken to complete the import in seconds
  * @param isVisible
  *   Whether to display this summary
  */
case class TransactionCountSummaryViewModel(
    ...
    /** Gets a formatted string representation of the completion time.
      *
      * @return
      *   A string with the completion time in seconds, or empty if not available
      */
    ...
    /** Gets a formatted string representation of the transaction count.
      *
      * @return
      *   A string with the transaction count
      */
...
end TransactionCountSummaryViewModel
