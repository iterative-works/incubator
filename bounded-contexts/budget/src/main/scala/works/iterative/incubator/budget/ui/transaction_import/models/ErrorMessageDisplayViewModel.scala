 ...
 * @param errorCode A unique code for support reference
 * @param isVisible Whether to display the error
 */
case class ErrorMessageDisplayViewModel(
     ...
     *
     * @return A standardized error title
     */
     ...
     *
     * @return A helpful message with next steps
     */
     ...
     *
     * @return true if the error appears to be connection-related
     */
     ...
     *
     * @return A specific suggestion based on error analysis
     */
