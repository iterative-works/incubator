 ...
 * @param isLoading Whether import is in progress
...
case class ImportButtonViewModel(
     ...
     *
     * @return "Importing..." when loading, "Import Transactions" otherwise
     */
     ...
     *
     * @return true if the button is either not enabled or is in loading state
     */
