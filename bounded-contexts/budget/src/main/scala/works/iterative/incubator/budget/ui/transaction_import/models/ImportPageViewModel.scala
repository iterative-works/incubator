 ...
 *
 * @param startDate The start date for the transaction import range, defaults to the first day of the current month
 * @param endDate The end date for the transaction import range, defaults to the current date
 * @param importStatus The current status of the import operation
 * @param importResults Optional results of the import operation
 * @param validationError Optional error message related to input validation
 */
case class ImportPageViewModel(
     ...
     *
     * @return true if no validation error exists and the dates are valid
     */
    def isValid: Boolean = 
     ...
     *
     * @return true if the import status is InProgress
     */
     ...
     *
     * @return true if the import has either completed successfully or failed with an error
     */
