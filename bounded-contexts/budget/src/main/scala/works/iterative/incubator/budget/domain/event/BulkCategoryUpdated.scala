...
/** Event emitted when multiple transactions are updated with the same category.
  *
  * This event is published when a user performs a bulk update to assign the same category to
  ...
  *   Description of the criteria used to select the transactions
  * @param occurredAt
  *   When the bulk update happened
  */
