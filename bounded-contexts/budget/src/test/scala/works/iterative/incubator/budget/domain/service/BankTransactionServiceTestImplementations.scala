...
end TestBankTransactionService
    ...
    val layer: ULayer[BankTransactionService] = ZLayer.succeed(
        new BankTransactionService:
            ...
            override protected def validateBankSpecificDateRange(
                ...
                val maxDays =
                    MaxDateRangeDays.getOrElse(accountId.bankId, MaxDateRangeDays("default"))
            ...
            override def fetchTransactions(
                ...
                ZIO.succeed(TestBankTransactionService.generateTransactions(
                    accountId,
                    startDate,
                    importBatchId,
