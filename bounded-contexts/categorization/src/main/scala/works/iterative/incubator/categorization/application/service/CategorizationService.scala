...
/** Service interface for AI-based transaction categorization
  *
  * This service provides methods for categorizing transactions using various approaches, including
  * rule-based matching and machine learning algorithms.
  *
...
trait CategorizationService:
    ...
    /** Get all categorization rules
      *
      * @return
      *   A list of all categorization rules
      */
    ...
    /** Train the categorization model with new examples
      *
      * @param examples
      *   List of (description, category) pairs for training
      * @return
      *   Unit
      */
