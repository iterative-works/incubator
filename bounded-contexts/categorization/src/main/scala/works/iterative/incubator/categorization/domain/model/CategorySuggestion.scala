...
/** Represents a category suggestion generated by AI for a transaction
  *
  * This entity represents a suggestion made by an AI system for categorizing a financial
  * transaction. It contains the suggested category, confidence level, and metadata about how the
