...
/** Example views for source accounts. Simplified versions of the real SourceAccountModule views.
  */
    ...
    def listView(accounts: List[SourceAccount]): TypedTag[String] =
        div(cls := "container mx-auto")(
            ...
            div(cls := "flex justify-end mb-4")(
                a(href := "#", cls := "px-4 py-2 bg-green-500 text-white rounded")(
                    "Add New Account"
                )
            ),
                                ...
                                tr(cls := "border-b border-gray-200 hover:bg-gray-100")(
                                    ...
                                    td(cls := "py-3 px-6 text-left")(
                                        if account.active then
                                            span(
                                                cls := "bg-green-200 text-green-700 py-1 px-3 rounded-full text-xs"
                                            )("Active")
                                        else
                                            span(
                                                cls := "bg-gray-200 text-gray-700 py-1 px-3 rounded-full text-xs"
                                            )("Inactive")
                                    ),
                                    td(cls := "py-3 px-6 text-right")(
                                        ...
                                        a(
                                            href := "#",
                                            cls := "text-yellow-500 hover:underline mr-2"
                                        )("Edit"),
        ...
        div(cls := "container mx-auto")(
            ...
            div(cls := "bg-white shadow rounded p-6")(
                form(action := "#", method := "post")(
                    div(cls := "mb-4")(
                        label(cls := "block text-gray-700 text-sm font-bold mb-2", `for` := "name")(
                            "Account Name"
                        ),
                        input(
